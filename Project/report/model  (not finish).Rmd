...
```{r summary glm-model, echo=FALSE, warning=FALSE, message=FALSE}
...
```{r, echo=FALSE, fig.cap="A caption", out.width = '50%', warning=FALSE, message=FALSE}
...
#### Linear Discriminant Analysis {.tabset .tabset-fade .tabset-pills}
...
#### Quadratic discriminant analysis {.tabset .tabset-fade .tabset-pills}
...
#### Functional data analysis (FDA) {.tabset .tabset-fade .tabset-pills}
...
```{r nn-model, echo=TRUE, message=FALSE, warning=FALSE}
...
```{r nnb-model, echo=TRUE, warning=FALSE, message=FALSE}
...
```{r xgb-model, echo=TRUE, message=FALSE, warning=FALSE}
...
```{r xgbb-model, echo=TRUE, warning=FALSE, message=FALSE}
