...
Firstly, we need to standardize the data, as the variables have different scales. We will normlize only the continuous variables, as the categorical and dummy variables have only few different levels.  
