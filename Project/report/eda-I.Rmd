...
| By response            |  The variables which stand out more are: CHK_ACCT and EMPLOYMENT. We can observe that each box by group are different between each other. | 
...
| 1           | No, there is any missing values in the data. | 
